...
if __name__ == '__main__':
    ...
    train = DataLoader(train_datasets, batch_size=1, num_workers=cpu_count(), shuffle=True)
    val = DataLoader(val_datasets, batch_size=1, num_workers=cpu_count(), shuffle=True)
